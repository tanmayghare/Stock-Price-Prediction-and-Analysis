...
start_time = input("Enter the start date for generating dataset (In YYYY.MM.DD format):")
year, month, day = map(int, start_time.split('.'))
start = dt.datetime(year,month,day)
end_time = input("Enter the end date for generating dataset (In YYYY.MM.DD format):")
...
print(f"Predicted price of {company} next day: {prediction}")